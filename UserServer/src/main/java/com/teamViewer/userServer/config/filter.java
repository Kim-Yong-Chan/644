package com.teamViewer.userServer.config;
...
public class filter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
		...
		response.setHeader("Access-Control-Allow-Headers", "Content-Type, X-Requested-With ");   //요청 허용 헤더(ajax : X-Requested-With)   //요청 허용 헤더(ajax : X-Requested-With)
